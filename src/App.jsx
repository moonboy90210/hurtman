...
export default function HurtmanWebsite() {
  ...
  const heroSlides = [
    ...
    { text: "UNDERGROUND", subtext: "STREETWEAR" },
  ];
    ...
    <div className="bg-black text-white min-h-screen font-sans">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div
          ...
          style={{
            backgroundImage:
              "url(https://images.unsplash.com/photo-1558769132-cb1aea1f1c0b?w=1920&h=1080&fit=crop)",
            filter: "brightness(0.4) contrast(1.1)",
          }}
        ></div>

        <div className="relative z-20 text-center px-6 max-w-4xl">
          <div className="overflow-hidden h-22 mb-4">
            {heroSlides.map((slide, index) => (
              ...
              >
                ...
                <p className="text-2xl md:text-4xl text-purple-400 font-light tracking-wider mb-2">
                  {slide.subtext}
                </p>
              </div>
            ))}
          ...
          {[0, 1, 2].map((index) => (
            <button
              ...
              className={`w-2 h-2 rounded-full transition-all ${
                currentSlide === index ? "bg-purple-500 w-8" : "bg-gray-600"
              }`}
            />
          ))}
        </div>
      ...
      <section className="py-20 px-6 bg-gradient-to-b from-black to-purple-950/20">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 leading-relaxed mb-6">
            TUFF TIMES LAST BUT WE PERSIST AGAINST ALL ODDS. REGARDLESS ANY SET
            BACK WE STAY HEAD STRONG AND KEEP PUSHING. WE MAY BE HURT BUT FUCK
            IT WE BALL, THAT IS THE HURTMAN WAY.
          </p>
          <p className="text-lg text-gray-400">
            THIS IS FASHION. LIMITED. EXCLUSIVE. PAIN BUILT.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-gray-300 text-lg mb-6 leading-relaxed">
              Rooted in Lagos youth culture, music, and nightlife. Every
              collection is a statement. Every drop is limited. We don't chase
              trends—we set them.
            </p>
            <p className="text-gray-400 mb-8">
              For the youth who refuse to be defined by their pain. For those
              who keep showing up, no matter what.
            </p>
      ...
      <section className="py-20 px-6 bg-black">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-gray-400 mb-8">
            Get early access to drops, exclusive content, and the culture.
          </p>
      ...
      <footer className="bg-black border-t border-gray-900 py-12 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            <div>
              ...
              <p className="text-gray-400 text-sm">
                Tuff times last yet we persist against all odds. We may be hurt,
                but fuck it we ball.
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <div className="flex space-x-4">
                <a href="http://instagram.com/hurtmanway" target="_blank">
                  <svg
                ...
                <a href="http://x.com/hurtmanway" target="_blank">
                  <svg
                    className="w-6 h-6 cursor-pointer hover:text-purple-400 transition-colors"
                    fill="currentColor"
                    viewBox="0 0 24 24"
          ...
          <div className="border-t border-gray-900 pt-8 text-center text-gray-500 text-sm">
            <p>© 2026 HURTMAN FITS. 4K IT WE BALL.</p>
          </div>
        </div>
      </footer>
    </div>
